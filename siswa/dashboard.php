              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Terima kasih telah melakukan pendaftaran di SMA ST.KLAUS KUWU . Pengumuman pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">5 Juli 2022</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMA ST.KLAUS KUWU</marquee>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda lolos seleksi di SMA ST.KLAUS KUWU. Lakukan Daftar Ulang pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">10 juli 2022</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMA ST.KLAUS KUWU</marquee>
                  </div>
        ...
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <p class="text-danger mt-3">* Wajib melakukan Daftar Ulang pada tanggal: 10 Juli 2022</p>
            </div>
          </div>
        </div>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="card-body">
                ...
                <br>
                <div class="text-right">
                    <a href="editprofil.php" class="btn btn-warning btn-sm"  style="text-align: center">Edit Profil</a>
                    <!-- <a href="<?= $base_url ?>#<?= $data_pendaftar['id'] ?>" class="btn btn-success btn-sm float-left" target="_blank">Data Diri Anda</a> -->
                </div>
                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item">
                    ...
                    <small class="text-muted">Katolik</small>
                  </li>
                  <li class="list-group-item">
