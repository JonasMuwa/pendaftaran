...
<head>
  ...
  <meta name="description" content="Aplikasi pendaftaran Siswa SMA ST.KLAUS KUWU.">
  ...
  <!-- gambar title -->
  <link rel="icon" type="image/png" href="assets/img/klaus.png">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="p-5">
                  ...
                  <img src="assets/img/klaus.png" alt="Logo sekolah" class="logo-login">
                    <h1 class="h4 text-gray-900 mb-4">Registrasi Siswa Baru</h1>
                    <h1 class="h4 text-gray-900 mb-4"><b>SMA ST.KLAUS KUWU</b></h1>
                  </div>
