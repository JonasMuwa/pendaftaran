...
<div style="margin-left: 20px">
    <div style="font-size: 18px">Data Pendaftaran Siswa Baru | TAHUN 2022.2023</div>
    <div style="font-size:20px">SMA ST.KLAUS KUWU</div>
    <div style="font-size: 12px">Kuwu,Desa Poco Likang,Kecamatan Ruteng Kabupaten Manggarai,NTT</div>
</div>
